...
- Concurrent players/agents must use separate smx gameplay profiles/session files. Do not coordinate them by mutating the official store's shared `activeAccount`.
