...
The 2026-09-17 run is stored in `results.json`. The comparison used the Auto Declip sources at `b123441`, deterministic linear and cubic-Hermite baselines, and Audacity Clip Fix 2.3.0-2 semantics with `Threshold=95%` and `Gain=0 dB`.
